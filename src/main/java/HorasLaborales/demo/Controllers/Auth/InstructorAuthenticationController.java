...
public class InstructorAuthenticationController {
    ...
    public ResponseEntity<?> changeInstructorPassword(@PathVariable Long id, @RequestBody Map<String, String> passwords) {
        try {
            ...
            boolean success = instructorAuthenticationService.changeInstructorPassword(id, oldPassword, newPassword);
            if (success) {
